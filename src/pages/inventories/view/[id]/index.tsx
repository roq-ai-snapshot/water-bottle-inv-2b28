        ...
        {isLoading ? (
          ...
          <>
            <FormWrapper wrapperProps={{ border: 'none', gap: 3, p: 0 }}>
              ...
              >
                <FormListItem label="Water Bottle Type" text={data?.water_bottle_type} />

                <FormListItem label="Quantity" text={data?.quantity} />

                <FormListItem label="Minimum Stock Level" text={data?.minimum_stock_level} />

                <FormListItem label="Maximum Stock Level" text={data?.maximum_stock_level} />
