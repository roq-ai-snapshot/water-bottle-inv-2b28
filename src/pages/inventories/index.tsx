...
export function InventoryListPage(props: InventoryListPageProps) {
  ...
  const queryParams = useMemo(
    () =>
      convertQueryToPrismaUtil(
        {
          relations: ['company', 'sales.count', 'supply_chain.count'],
          searchTerm: params.searchTerm,
          searchTermKeys: ['water_bottle_type.contains'],
          ...params.filters,
        },
        'inventory',
      ),
  ...
  const columns: ColumnType[] = [
    { id: 'water_bottle_type', header: 'Water Bottle Type', accessorKey: 'water_bottle_type' },
    { id: 'quantity', header: 'quantity', accessorKey: 'quantity' },
    { id: 'minimum_stock_level', header: 'minimum_stock_level', accessorKey: 'minimum_stock_level' },
    { id: 'maximum_stock_level', header: 'maximum_stock_level', accessorKey: 'maximum_stock_level' },
