    ...
    >
      <Box rounded="md">
        ...
        <FormWrapper onSubmit={formik.handleSubmit}>
          <TextInput
            error={formik.errors.water_bottle_type}
            label={'Water Bottle Type'}
            props={{
              name: 'water_bottle_type',
              placeholder: 'Water Bottle Type',
              value: formik.values?.water_bottle_type,
          ...
          <NumberInput
            ...
            formControlProps={{
              ...
              isInvalid: !!formik.errors?.minimum_stock_level,
            }}
            name="minimum_stock_level"
            error={formik.errors?.minimum_stock_level}
            value={formik.values?.minimum_stock_level}
            onChange={(valueString, valueNumber) =>
              formik.setFieldValue('minimum_stock_level', Number.isNaN(valueNumber) ? 0 : valueNumber)
            }
          />
          ...
          <NumberInput
            ...
            formControlProps={{
              ...
              isInvalid: !!formik.errors?.maximum_stock_level,
            }}
            name="maximum_stock_level"
            error={formik.errors?.maximum_stock_level}
            value={formik.values?.maximum_stock_level}
            onChange={(valueString, valueNumber) =>
              formik.setFieldValue('maximum_stock_level', Number.isNaN(valueNumber) ? 0 : valueNumber)
            }
          />
