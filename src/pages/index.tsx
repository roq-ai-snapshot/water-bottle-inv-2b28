...
function HomePage() {
  ...
  return (
    <>
      <Head>
        <title>{`water bottle inventory management application`}</title>

        <meta
          name="description"
          content="Unleash the power of efficiency with Water Bottle Inventory Management Application. Streamline your operations, reduce waste, and optimize your stock like never before."
        />
      </Head>
      <ConfigureCodeBanner
      ...
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1602143407151-7111542de6e8?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHx3YXRlciUyMGJvdHRsZXxlbnwwfHx8fDE2OTcxNzA1ODd8MA&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
          ...
          <Box position="absolute" top="0" backgroundColor="rgba(0,0,0,0.6)" width="100%" py="2">
            <Text align="center" fontSize="sm" color="white">
              Photo by{' '}
              <Link
                href="https://unsplash.com/@joanofarts?utm_source=roq-generator&utm_medium=referral"
                isExternal
                color="teal.200"
              >{`Joan Tran`}</Link>{' '}
              on{' '}
        ...
        >
          <Box>
            <Heading mb={{ base: '12px', lg: '20px' }} size="2xl">
              {`water bottle inventory management application`}
            </Heading>
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Unleash the power of efficiency with Water Bottle Inventory Management Application. Streamline your operations, reduce waste, and optimize your stock like never before.`}
            </Text>
            <Box
