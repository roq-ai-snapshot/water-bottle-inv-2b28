...
export const AppLogo = (props: AppLogoProps) => {
  ...
  const ownerRoles = ['owner', 'inventory-manager', 'sales-representative', 'supply-chain-analyst', 'customer'];
  const appName = `water bottle inventory management application`;
